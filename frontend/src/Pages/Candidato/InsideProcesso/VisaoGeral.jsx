                    ...
                    return (
                        ...
                        <TabPanel className="text-md" header={tab.title}>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-x-3 gap-y-2">
                                <div className="bg-green-200 flex flex-row p-2 rounded-md gap-4 items-center shadow-md">
                                ...
                                <div className="bg-yellow-200 flex flex-row p-2 rounded-md gap-4 items-center shadow-md">
