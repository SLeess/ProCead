...
import { useFormValidation } from './useFormValidation'; // Adjust path if needed
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <FormField obrigatorio={true} label="CPF">
                ...
                />
                {errors.cpf && <span className="text-red-500 animate-fade-in text-sm mt-1 ml-1">{errors.cpf}</span>}
              </FormField>
              <FormField obrigatorio={true} label="E-mail">
                <TextInput value={formData.email} onChange={(e) => handleOnChangeAttr(e, "email")} placeholder="ex: exemplo@gmail.com" onBlur={() => handleBlur('email')} />
                {errors.email && <span className="text-red-500 animate-fade-in text-sm mt-1 ml-1">{errors.email}</span>}
              </FormField>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
              <FormField obrigatorio={true} label="Data de Nascimento">
                <IMaskInput
                  ...
                  className="w-full py-[0.42rem] px-3 border-2 text-sm border-gray-300 rounded-md"
                />
                {errors.data_nascimento && <span className="text-red-500 text-sm mt-1 ml-1 animate-fade-in">{errors.data_nascimento}</span>}
              </FormField>
              <FormField obrigatorio={true} label="Telefone">
                <IMaskInput
                  ...
                  className="w-full py-[0.42rem] px-3 border-2 text-sm border-gray-300 rounded-md"
                />
                {errors.telefone && <span className="text-red-500 animate-fade-in text-sm mt-1 ml-1">{errors.telefone}</span>}
              </FormField>
