            ...
            <div id="edital-body">
                ...
                <div className="edital-forms">
                    ...
                    <FormField label="Formato das notas" className="sm:col-span-4 lg:col-span-2">
                        <SelectInput value={formData.formato_notas} readOnly={true} onChange={(e) => handleOnChangeAttr(e, "formato_notas")} options={['...', '']} />
                    </FormField>
                    <FormField label="Candidato se inscreve em" className="sm:col-span-4 lg:col-span-3">
                        <SelectInput value={formData.tipo_inscricao} readOnly={true} onChange={(e) => handleOnChangeAttr(e, "tipo_inscricao")} options={['...', '']} />
                    </FormField>
                    <FormField label="Valor máximo de itens que se pode inscrever" className="sm:col-span-3 lg:col-span-4">
                        <TextInput value={formData.max_itens_inscricao} readOnly={true} onChange={(e) => handleOnChangeAttr(e, "max_itens_inscricao")} placeholder="Ex: 2" />
                    </FormField>
                    <FormField label="Valor máximo de itens que se pode tomar posse" className="sm:col-span-3 lg:col-span-4">
                        <TextInput value={formData.max_itens_posse} readOnly={true} onChange={(e) => handleOnChangeAttr(e, "max_itens_posse")} placeholder="Ex: 2" />
                    </FormField>
                    ...
                    <FormField label="Habilitar remanejamento de vagas" className="sm:col-span-3 lg:col-span-3">
                        <SelectInput value={formData.remanejamento} readOnly={true} onChange={(e) => handleOnChangeAttr(e, "remanejamento")} options={['...', '']} />
                    </FormField>
                    <FormField label="Edital possui categorias?" className="sm:col-span-2 md:col-span-3 lg:col-span-3">
                        <SelectInput value={formData.has_categorias} readOnly={true} onChange={(e) => handleOnChangeAttr(e, "has_categorias")} options={['...', '']} />
                    </FormField>
                    <FormField label="Tipos de Avaliação para Reserva de Vagas" className="sm:col-span-3 lg:col-span-4">
                        <SelectInput value={formData.tipo_avaliacao_cotas} readOnly={true} onChange={(e) => handleOnChangeAttr(e, "tipo_avaliacao_cotas")} options={['...', '']} />
                    </FormField>
                </div>
