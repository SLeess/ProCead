...
const AnexoDeleteModal = ({ anexo, setNeedUpdate }) => {
    ...
    const handleDelete = async () => {
        ...
        try {
            ...
            if (!res.ok) {
                ...
                toast.error(result.message || 'Erro ao deletar anexo.');
                return;
            }
                    ...
                    <div className="flex items-center justify-center p-4 font-sans">
                        <div className="relative text-center">
                            ...
                            <p className="text-gray-600 mb-8">
                                Tem certeza que deseja deletar o anexo "{anexo.nome}"?
                            </p>
...
export default AnexoDeleteModal;