...
const Header = () => {
  return (
    <HeaderModel headerid={'admin'}>
      ...
      <NavLink end to="/admin/relatorios-custom" className={({ isActive }) => `link-page my-2 ${isActive ? "active-link md:border-b-2 border-secondary dark:border-primary" : ""}`}>Relatórios Customizados</NavLink>
    </HeaderModel>
  );
};
