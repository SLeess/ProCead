        ...
        <section className={styles.section_profile}>
            <div className="container">
                ...
                <div className="relative inline-block">
                    ...
                    className={`absolute border-slate-800 border-1 right-0 top-full w-[240px] divide-y divide-stroke overflow-hidden rounded-lg bg-white dark:divide-dark-3 dark:bg-dark-2 ${dropdownOpen ? "block" : "hidden"}`}
                    >
                    ...
                    <div>
                        <button onClick={() => handlerLogOut()} className={`${styles.logout} text-dark`}>
                            Sair
                        </button>
                    </div>
                    </div>
