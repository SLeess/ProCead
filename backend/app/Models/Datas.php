...
class Datas extends Model
{
    ...
    protected $fillable = [
        ...
        'start_avaliacao_junta_medica',
        'end_avaliacao_junta_medica',
    ...
    protected $casts = [
        ...
        'resultado_preliminar_geral' => 'datetime',
        'resultado_preliminar_inscricao' => 'datetime',
        ...
        'start_avaliacao_junta_medica' => 'datetime',
        'end_avaliacao_junta_medica' => 'datetime',
