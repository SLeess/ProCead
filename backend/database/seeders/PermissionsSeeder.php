...
class PermissionsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $arrayOfLocalPermissionNames = [
            ...
            "socioeconomico-avaliar" => " Avaliar todas as cotas que pertencem a modalidade socioeconômica",
            "heteroidentificacao-avaliar" => " Avaliar todas as cotas que pertencem a modalidade heteroidentificação",
            "junta_medica-avaliar" => " Avaliar todas as cotas que pertencem a modalidade junta médica",
            "etnica-avaliar" => " Avaliar todas as cotas que pertencem a modalidade etnica",
            "genero-avaliar" => " Avaliar todas as cotas que pertencem a modalidade identidade de gênero",
        ];
