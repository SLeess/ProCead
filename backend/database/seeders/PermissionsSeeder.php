...
class PermissionsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $arrayOfLocalPermissionNames = [
            ...
            "visualizar-permissoes-do-perfil" => " Visualizar permissões de cada perfil separadamente.",
            "editar-permissoes-do-perfil" => "Editar permissões de cada perfil separadamente.",
            ...
            "visualizar-avaliacao-socioeconomico" => "Visualizar os dados da inscrição na cota selecionada que pertencem a modalidade socioeconômica",
            "editar-avaliacao-socioeconomico" => "Avaliar todas as cotas que pertencem a modalidade socioeconômica",
            "visualizar-avaliacao-heteroidentificacao" => "Visualizar os dados da inscrição na cota selecionada que pertencem a modalidade heteroidentificação",
            "editar-avaliacao-heteroidentificacao" => " Avaliar todas as cotas que pertencem a modalidade heteroidentificação",
            "visualizar-avaliacao-junta-medica" => "Visualizar os dados da inscrição na cota selecionada que pertencem a modalidade médica",
            "editar-avaliacao-junta-medica" => " Avaliar todas as cotas que pertencem a modalidade junta médica",
            "visualizar-avaliacao-etnica" => "Visualizar os dados da inscrição na cota selecionada que pertencem a modalidade etnica",
            "editar-avaliacao-etnica" => " Avaliar todas as cotas que pertencem a modalidade etnica",
            "visualizar-avaliacao-genero" => "Visualizar os dados da inscrição na cota selecionada que pertencem a modalidade identidade de gênero",
            "editar-avaliacao-genero" => " Avaliar todas as cotas que pertencem a modalidade identidade de gênero",
        ];
