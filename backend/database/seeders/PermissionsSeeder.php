...
class PermissionsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $arrayOfLocalPermissionNames = [
            ...
            "visualizar-avaliacao-junta_medica" => "Visualizar os dados da inscrição na cota selecionada que pertencem a modalidade médica",
            "editar-avaliacao-junta_medica" => " Avaliar todas as cotas que pertencem a modalidade junta médica",
